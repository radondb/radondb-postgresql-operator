...
import (
	...
	v1 "github.com/radondb/radondb-postgresql-operator/pkg/apis/radondb.com/v1"
	scheme "github.com/radondb/radondb-postgresql-operator/pkg/generated/clientset/versioned/scheme"
...
func newPgpolicies(c *RadondbV1Client, namespace string) *pgpolicies {
	return &pgpolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pgpolicies) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Pgpolicy, err error) {
	result = &v1.Pgpolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgpolicies").
...
func (c *pgpolicies) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PgpolicyList, err error) {
...
func (c *pgpolicies) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pgpolicies) Create(ctx context.Context, pgpolicy *v1.Pgpolicy, opts metav1.CreateOptions) (result *v1.Pgpolicy, err error) {
	result = &v1.Pgpolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pgpolicies").
...
func (c *pgpolicies) Update(ctx context.Context, pgpolicy *v1.Pgpolicy, opts metav1.UpdateOptions) (result *v1.Pgpolicy, err error) {
	result = &v1.Pgpolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgpolicies").
...
func (c *pgpolicies) UpdateStatus(ctx context.Context, pgpolicy *v1.Pgpolicy, opts metav1.UpdateOptions) (result *v1.Pgpolicy, err error) {
	result = &v1.Pgpolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgpolicies").
...
func (c *pgpolicies) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *pgpolicies) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *pgpolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Pgpolicy, err error) {
	result = &v1.Pgpolicy{}
