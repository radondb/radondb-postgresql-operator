...
func (c *pgclusters) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Pgcluster, err error) {
	result = &v1.Pgcluster{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgclusters").
...
func (c *pgclusters) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PgclusterList, err error) {
...
func (c *pgclusters) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pgclusters) Create(ctx context.Context, pgcluster *v1.Pgcluster, opts metav1.CreateOptions) (result *v1.Pgcluster, err error) {
	result = &v1.Pgcluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pgclusters").
...
func (c *pgclusters) Update(ctx context.Context, pgcluster *v1.Pgcluster, opts metav1.UpdateOptions) (result *v1.Pgcluster, err error) {
	result = &v1.Pgcluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgclusters").
...
func (c *pgclusters) UpdateStatus(ctx context.Context, pgcluster *v1.Pgcluster, opts metav1.UpdateOptions) (result *v1.Pgcluster, err error) {
	result = &v1.Pgcluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgclusters").
...
func (c *pgclusters) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *pgclusters) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *pgclusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Pgcluster, err error) {
	result = &v1.Pgcluster{}
