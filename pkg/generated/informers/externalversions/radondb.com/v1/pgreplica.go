...
import (
	...
	v1 "github.com/radondb/radondb-postgresql-operator/pkg/generated/listers/radondb.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RadondbV1().Pgreplicas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RadondbV1().Pgreplicas(namespace).Watch(context.TODO(), options)
			},
		},
		&radondbcomv1.Pgreplica{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pgreplicaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&radondbcomv1.Pgreplica{}, f.defaultInformer)
}
