	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.QingcloudV1().Pgreplicas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QingcloudV1().Pgreplicas(namespace).Watch(context.TODO(), options)
			},
		},
		&qingcloudcomv1.Pgreplica{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pgreplicaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&qingcloudcomv1.Pgreplica{}, f.defaultInformer)
}
