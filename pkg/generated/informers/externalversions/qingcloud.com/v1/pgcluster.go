	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.QingcloudV1().Pgclusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QingcloudV1().Pgclusters(namespace).Watch(context.TODO(), options)
			},
		},
		&qingcloudcomv1.Pgcluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pgclusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&qingcloudcomv1.Pgcluster{}, f.defaultInformer)
}
